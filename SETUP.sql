...
CREATE TABLE TB_OLAP_DIM_CLIENTE
(
    ID_CLIENTE INT NOT NULL,
    ESTADO_CIVIL INT NOT NULL -- 0: SOLTEIRO | 1: CASADO | 2: VIUVO | 3: UNIAO ESTAVEL
);

ALTER TABLE TB_OLAP_DIM_CLIENTE ADD CONSTRAINT PK_OLAP_DIM_CLIENTE PRIMARY KEY (ID_CLIENTE);
...
ALTER TABLE TB_OLAP_FAT_COMPRA ADD CONSTRAINT FK_OLAP_COMPRA_CLIENTE FOREIGN KEY (ID_CLIENTE) REFERENCES TB_OLAP_DIM_CLIENTE(ID_CLIENTE);
