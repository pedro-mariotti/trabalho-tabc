...
(
    ID_ESTADO_CIVIL INT NOT NULL,
    ESTADO_CIVIL CHAR(1) NOT NULL -- 0: SOLTEIRO | 1: CASADO | 2: VIUVO | 3: UNIAO ESTAVEL
);

ALTER TABLE TB_OLAP_DIM_ESTADO_CIVIL ADD CONSTRAINT PK_OLAP_DIM_ESTADO_CIVIL PRIMARY KEY (ID_ESTADO_CIVIL);
...
ALTER TABLE TB_OLAP_FAT_COMPRA ADD CONSTRAINT FK_OLAP_COMPRA_ESTADO_CIVIL FOREIGN KEY (ID_ESTADO_CIVIL) REFERENCES TB_OLAP_DIM_ESTADO_CIVIL(ID_ESTADO_CIVIL);
...
ALTER TABLE CLIENTE ADD ESTADO_CIVIL CHAR(1) NOT NULL;
